class ProductsController < ApplicationController
  ...
  COLORS = {
    ...
    "Blue" => "rgb(0, 0, 255)",
    "BlueCheerios/Navy Blue" => "background Blue Cheerios",
    "Bob" => "background Bob",
    "Brown" => "rgb(100, 84, 58)",
    "Brick" => "background brick",
    "Burgundy" => "rgb(130, 34, 80)",
    "Burgundy/Navy" => "background burgundynavy",
    "Cappuccino" => "rgb(60, 27, 18)",
    "Caribbean" => "rgb(19, 96, 125)",
    "Ceil" => "rgb(126, 159, 218)",
    "Charcoal" => "rgb(85, 90, 94)",
    "Charcoal/Black" => "background charcoalblack",
    "Charcoal/Lilac" => "background charcoalpostman",
    ...
    "DeepOrchid/White" => "background deeporchidwhite",
    ...
    "FireWorks" => "background Fireworks",
    "FlorescentButterfly" => "background Florescent Butterfly",
    ...
    "Khaki/Black" => "background khakiblack",
